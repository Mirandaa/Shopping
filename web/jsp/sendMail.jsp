...
<%
    ...
    String myEmailAccount = "Plainning@163.com";
    String myEmailPassword = "tdk123321";
    ...
    //MimeMessage message = createMimeMessage(session1, myEmailAccount, receiveMailAccount);
    ...
    // 2. From: 发件人（昵称有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改昵称）
    message.setFrom(new InternetAddress(sendMail, "千寻网", "UTF-8"));
    ...
    // 5. Content: 邮件正文（可以使用html标签）（内容有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改发送内容）
    message.setContent("XX用户你好, 您的验证码是：", "text/html;charset=UTF-8");
